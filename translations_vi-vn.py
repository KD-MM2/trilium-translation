translation_dict = {
    ...
    "Sync has been correctly set up. It will take some time for the initial sync to finish. Once it's done, you'll be redirected to the login page.": 'Đã hoàn tất đồng bộ. Sẽ mất một lát để lần đồng bộ đầu tiên hoàn tất. Bạn sẽ được chuyển hướng đến trang đăng nhập sau khi đồng bộ hoàn tất.',
    'N/A': 'Không xác định',
