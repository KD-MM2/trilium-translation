translation_dict = {
    ...
    'Trilium requires JavaScript to be enabled.': 'Trilium yêu cầu bật JavaScript',
    'Login': 'Đăng nhập',
    'Trilium login': 'Đăng nhập Trilium',
    'Username': 'Tên người dùng',
    'Password': 'Mật khẩu',
    'Remember me': 'Ghi nhớ đăng nhập',
    'Username and / or password are incorrect. Please try again.': 'Sai tên người dùng hoặc mật khẩu. Vui lòng thử lại.',
    'Setup': 'Thiết lập',
    'Trilium Notes setup': 'Thiết lập Trilium Notes',
    'Next': 'Tiếp tục',
    'New document': 'Tài liệu mới',
    'Repeat password': 'Đặt lại mật khẩu',
    'Theme': 'Chủ đề',
    'white': 'trắng',
    'light': 'sáng',
    'dark': 'tối',
    'black': 'đen',
    'Theme can be later changed in Options -> Appearance.': 'Chủ đề có thể thay đổi sau trong Tuỳ chọn -> Hiển thị.',
    'Back': 'Quay lại',
    'Finish setup': 'Hoàn tất thiết lập',
    'Document initialization in progress': 'Đang khởi tạo tài liệu',
    'You will be shortly redirected to the application.': 'Bạn sẽ sớm được chuyển hướng tới ứng dụng.',
    'Sync from Desktop': 'Đồng bộ từ Desktop',
    'This setup needs to be initiated from the desktop instance:': 'Quá trình thiết lập này cần được thực hiện từ phiên bản Desktop:',
    'please open your desktop instance of Trilium Notes': 'vui lòng mở Trilium Notes phiên bản Desktop',
    'click on Options button in the top right': 'nhấn vào nút Tuỳ chọn ở góc phía trên bên phải',
    'click on Sync tab': 'nhấn vào tab Đồng bộ',
    'configure server instance address to the: ': 'cấu hình địa chỉ của phiên máy chủ thành: ',
    ' and click save.': ' và nhấn vào Lưu',
    'click on "Test sync" button': 'nhấn vào nút "Kiểm tra đồng bộ"',
    "once you've done all this, click ": 'sau khi hoàn tất, nhấn vào ',
    'here': 'đây',
    'Sync from Server': 'Đồng bộ từ Máy chủ',
    'Please enter Trilium server address and credentials below. This will download the whole Trilium document from server and setup sync to it. Depending on the document size and your connection speed, this may take a while.': 'Vui lòng điền địa chỉ máy chủ Trilium và thông tin đăng nhập bên dưới. Việc này sẽ tải xuống toàn bộ tài liệu của Trilium từ máy chủ. Sẽ mất một lúc tuỳ thuộc vào kích thước tài liệu và tốc độ mạng.',
    'Trilium server address': 'Địa chỉ máy chủ Trilium',
    'Proxy server (optional)': 'Máy chủ proxy(tuỳ chọn)',
    'Note:': 'Ghi chú',
    ' If you leave proxy setting blank, system proxy will be used (applies to desktop/electron build only)': 'Nếu bạn để trống cài đặt proxy, cài đặt của hệ thống sẽ được sử dụng(chỉ áp dụng cho phiên bản desktop/electron)',
    'Sync in progress': 'Đang đồng bộ',
    "Sync has been correctly set up. It will take some time for the initial sync to finish. Once it's done, you'll be redirected to the login page.": 'Đã hoàn tất đồng bộ. Lần đồng bộ đầu tiên sẽ mất thêm một chút thời gian để hoàn tất. Bạn sẽ được chuyển hướng đến trang đăng nhập sau khi đồng bộ hoàn tất.',
    'N/A': 'Không xác định',
    "I'm a new user, and I want to create a new Trilium document for my notes": 'Tôi là người mới và muốn tạo tài khoản Trilium mới để lưu trữ tài liệu, ghi chép',
    'I have a desktop instance already, and I want to set up sync with it': 'Tôi đã có phiên máy tính và muốn thiết lập đồng bộ',
    'I have a server instance already, and I want to set up sync with it': 'Tôi đã có phiên máy chủ và muốn thiết lập đồng bộ',
    "You're almost done with the setup. The last thing is to choose username and password using which you'll login to the application.": 'Thiết lập sắp hoàn tất. Cuối cùng bạn cần tạo tài khoản và mật khẩu để đăng nhập vào ứng dụng.',
    'This password is also used for generating encryption key which encrypts protected notes.': 'Mật khẩu này cũng được sử dụng để tạo khoá mã hoá dùng cho việc bảo vệ ghi chú.',
    'Choose alphanumeric username': 'Chọn tên người dùng bao gồm chữ và số',
    'Outstanding sync items': 'Những mục chưa đồng bộ',
    'Add "${params.misspelledWord}" to dictionary': 'Thêm "{params.misspelledWord}" vào từ điển',
    'Cut': 'Cắt',
    'Copy': 'Sao chép',
    'Copy link': 'Sao chép liên kết',
    'Paste': 'Dán',
    'Paste as plain text': 'Dán dưới dạng văn bản thuần tuý',
    '`Search for "${shortenedSelection}" with ${searchEngineName}`': '`Tìm kiếm "${shortenedSelection}" bằng ${searchEngineName}`',
    'About Trilium Notes': 'Về Trilium Notes',
    'Homepage:': 'Trang chủ:',
    'App version:': 'Phiên bản ứng dụng:',
    'DB version:': 'Phiên bản DB:',
    'Sync version:': 'Phiên bản đồng bộ:',
    'Build date:': 'Ngày dựng:',
    'Build revision:': 'Bản dựng sửa đổi:',
    'Data directory:': 'Thư mục dữ liệu:',
    'Add link': 'Thêm liên kết',
    'Note': 'Ghi chú',
    'Link title': 'Liên kết tiêu đề',
    'enter': 'enter',
    'Help on links': 'Giúp đỡ về liên kết',
    'search for note by its name': 'tìm kiếm ghi chú bằng tên',
    'Backend Log': 'Nhật ký hệ thống',
    'Refresh': 'Tải lại',
    'Edit branch prefix': 'Sửa tiền tố nhánh',
    'Prefix': 'Tiền tố:',
    'Save': 'Lưu',
    'Help on Tree prefix': 'Giúp đỡ về Tiền tố cây',
    'Clone notes to ...': 'Tạo bản sao ghi chú tới ...',
    'Notes to clone': 'Ghi chú để tạo bản sao',
    'Target parent note': 'Mục tiêu Ghi chú Mẹ',
    'Prefix (optional)': 'Tiền tố (tuỳ chọn)',
    'Clone to selected note ': 'Tạo bản sao ghi chú đã chọn',
    'Cloned note will be shown in note tree with given prefix': 'Bản sao của ghi chú sẽ được hiển thị trong Cây ghi chú với tiền tố đã cho',
    'Confirmation': 'Xác nhận',
    'Cancel': 'Huỷ bỏ',
    'OK': 'OK',
    'Delete notes preview': 'Xoá bản xem trước ghi chú',
    'Following notes will be deleted (': 'Những ghi chú sau sẽ bị xoá (',
    'Following  (': '',
...
<p>Alternatively you can add label and relation using the <code>+</code> button on the right side.</p>': '',
    ...
    'Unrecognized type ${defaultType}': '',
    'SQL Console note has been saved into ${await treeService.getNotePathTitle(notePath)}': '',
    'Opening API docs...': '',
    'Hide buttons': '',
    'Launcher': '',
    'Doc': '',
